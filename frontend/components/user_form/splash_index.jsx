...
const SplashIndex = ({demoLogin}) => (
  <div className="splash-index">
    <div className="strong-text important-text" style={{fontSize: '28px', lineHeight: '32px', letterSpacing: "0.15px"}}>Connect with friends and the world around you on Facespace.</div>
