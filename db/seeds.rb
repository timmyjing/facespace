...
User.create(first_name: "Aaron", last_name: "Wayne", email: "niartenyaw", gender: "male", birth_date: "1990/01/01", password: "sweetawesome", profile_img_url: "/assets/niartenyaw.jpeg", bio: "Instructor @ AppAcademy", location: "San Francisco")
